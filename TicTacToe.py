# reference from Invent with Python by Al Sweigart
#Kimberly Townsend
...
def inputPlayerLetter():
    ...
    while not (letter == 'x' or letter =='o'):
        ...
        letter = input().lower() #input is lowercase

    # the first element in the tuple is the player's letter, the second is the comptuer's letter.
    if letter == 'x':
        return ['x','o']
    else:
        return ['o','x']
...
def isWinner(bo, le):
    ...
    # We use bo instad of board and le instead of letter so we don't have to type as much.
...
def getComputerMove(board, computerLetter):
    ...
    #First, check if we can win in the next moveList
    for i in range(1, 10):
